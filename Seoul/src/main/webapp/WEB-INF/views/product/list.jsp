                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6" id="product-grid">
                    <c:forEach var="dto" items="${list}">
                        <div class="card-container">
                            <a href="<c:url value='/product/detail?productId=${dto.product_id}'/>" 
                               class="block bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                                ...
                                <div class="card-container">
                                    <a href="/product/detail?productId=\${product.product_id}" class="block bg-white rounded-lg shadow-md overflow-hidden transform hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <p class="text-xl font-bold text-gray-900" style="margin-bottom: 8px;">
                                                \${new Intl.NumberFormat('ko-KKR'.replace('KKR','KR')).format(product.price)}원
                                            </p>
